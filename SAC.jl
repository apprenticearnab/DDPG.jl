...
critic1 = Chain(Dense(state_size+action_size, 40, relu),Dense(40,40,relu),Dense(40,1))
critic2 = Chain(Dense(state_size+action_size, 40, relu),Dense(40,40,relu),Dense(40,1))
